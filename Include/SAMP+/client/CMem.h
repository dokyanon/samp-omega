...
public:
	...
	template<class T, class U> static void Add(U pMemory, T value);
	template<class T, class U> static void MemPut(U pMemory, T value);
	template<class T, class U> static void AddSlow(U pMemory, T value);
	template<class T, class U> static void Sub(U pMemory, T value);
...
template < class T, class U >
void CMem::MemPut(U ptr, const T value)
{
	if (*(T*)ptr != value)
		CMem::Cpy((void*)ptr, &value, sizeof (T));
}
...
template<class T, class U>
void CMem::Add(U pMemory, T value)
{
	*(T*)pMemory += value;
}

template<class T, class U>
void CMem::Sub(U pMemory, T value)
{
	*(T*)pMemory -= value;
}
